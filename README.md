...
- 🚧 **Phase 7 (next)** — categories: groups over finer categories, custom categories, hide/rename built-ins, merchant rules and renaming — [spec](docs/superpowers/specs/2026-09-24-phase-7-categories-design.md), awaiting review
